      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (e.target.value && endDate) window.dispatchEvent(new CustomEvent('onboarding:action', { detail: { id: 'dates-set' } }))
            }}
        ...
        <div>
          ...
          <input
            ...
            min={startDate || ''}
            onChange={(e) => {
              setDates(startDate || e.target.value, e.target.value)
              if (startDate && e.target.value) window.dispatchEvent(new CustomEvent('onboarding:action', { detail: { id: 'dates-set' } }))
            }}
            className="w-full bg-[#141820] border border-white/10 rounded px-4 py-3 text-white focus:outline-none focus:border-[#E67E22]/60 transition-colors"
          />
        </div>
