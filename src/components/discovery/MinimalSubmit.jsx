...
export default function MinimalSubmit({ onComplete, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="tactical-panel p-5 space-y-4">
      ...
      <div>
        <label className="text-[10px] font-mono text-[var(--text-secondary)]">DESTINATION</label>
        <input
          value={destination}
      ...
      <div>
        <label className="text-[10px] font-mono text-[var(--text-secondary)]">YOUR PIONEER NAME</label>
        <input
          value={architectName}
