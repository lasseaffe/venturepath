    ...
    <button
      ...
      className={`px-3 py-1 rounded-full text-[10px] font-mono border transition-colors ${
        active
          ...
          : 'border-white/20 text-[var(--text-secondary)] hover:border-[#E67E22]/50'
      }`}
    >
      {label}
    </button>
  ...
  return (
    <div className="space-y-3 mb-5">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <span className="text-[10px] font-mono text-[var(--text-muted)] w-16">DIFF</span>
        {DIFFICULTIES.map(d => (
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <span className="text-[10px] font-mono text-[var(--text-muted)] w-16">CLIMATE</span>
        {CLIMATES.map(c => (
      ...
      <div className="flex gap-2 items-center">
        <span className="text-[10px] font-mono text-[var(--text-muted)] w-16">PRICE</span>
