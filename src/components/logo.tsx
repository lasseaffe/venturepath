  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      >
        ...
        {/* Base platform */}
        <rect x="3" y="34" width="34" height="4.5" rx="2.25" fill="#3D6040" />
        {/* Entrance arch */}
        <path d="M15 34 Q20 30 25 34" fill="#2D4A2D" opacity="0.5" />
        {/* Finial dot (peach accent) */}
        <circle cx="20" cy="2.5" r="2.5" fill="#E8B49A" />
      ...
      {!iconOnly && (
        <span className={cn("font-semibold tracking-tight", text)} style={{ color: "#2D4A2D", letterSpacing: "-0.025em" }}>
          Holy<span style={{ color: "#C87A50", fontWeight: 300 }}>Flex</span>
        </span>
      )}
    </div>
  );
